...
document.getElementById("gray").innerHTML ="<img src='img/bitmaps/kamera4.jpg' style=width:900px;height:600px; />" ;

}
//function kamera1("v")

function kamera22(){
  document.getElementById("gray").innerHTML ="<img src='img/bitmaps/kamera3jpg.jpg' style=width:900px;height:600px; />" ;

}
function kamera33(){
  document.getElementById("gray").innerHTML ="<img src='img/bitmaps/kamera2.jpg' style=width:900px;height:600px;/>" ;

}
function kamera44(){
  document.getElementById("gray").innerHTML ="<img src='img/bitmaps/kamera.jpg' style=width:900px;height:600px;/>" ;
